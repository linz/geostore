...
LINZ_SCHEMA_DIRECTORY = "stac/v0.0.10/linz"
...
LINZ_STAC_GEOSPATIAL_TYPE_KEY = "linz:geospatial_type"
...
QUALITY_SCHEMA_PATH = "stac/v0.0.10/quality/schema.json"
QUALITY_STAC_EXTENSION_URL = f"https://linz.github.io/{QUALITY_SCHEMA_PATH}"
