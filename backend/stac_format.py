...
LATEST_LINZ_STAC_VERSION = "0.0.4"
LATEST_LINZ_SCHEMA_DIRECTORY = f"stac/v{LATEST_LINZ_STAC_VERSION}/linz"
LATEST_LINZ_SCHEMA_PATH = f"{LATEST_LINZ_SCHEMA_DIRECTORY}/schema.json"
LATEST_LINZ_STAC_EXTENSION_URL = f"https://linz.github.io/{LATEST_LINZ_SCHEMA_PATH}"
