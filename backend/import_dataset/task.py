...
IMPORT_ASSET_FILE_TASK_ARN = get_param(ParameterName.IMPORT_ASSET_FILE_FUNCTION_TASK_ARN)
IMPORT_METADATA_FILE_TASK_ARN = get_param(ParameterName.IMPORT_METADATA_FILE_FUNCTION_TASK_ARN)
