...
VALIDATION_RESULTS_TABLE_NAME = get_param(ParameterName.VALIDATION_RESULTS_TABLE_NAME.value)
...
def lambda_handler(event: JsonObject, _context: bytes) -> JsonObject:
    ...
    validation_result_factory = ValidationResultFactory(hash_key, VALIDATION_RESULTS_TABLE_NAME)
