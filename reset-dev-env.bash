...
then
    ...
    poetry install --extras='cdk check_files_checksums check_stac_metadata content_iterator datasets dataset_versions import_dataset import_status write_to_catalog validation_summary' --remove-untracked
fi
