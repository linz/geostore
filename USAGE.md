...
The ARN of our SNS Topic is `arn:aws:sns:ap-southeast-2:<YOUR_ACCOUNT_ID>:geostore-import-status`
which you may choose to subscribe to.
...
```json
{
  ...
  "TopicArn": "arn:aws:sns:ap-southeast-2:<YOUR_ACCOUNT_ID>:geostore-import-status",
  "Message": "{\"version\": \"0\", […]}",
